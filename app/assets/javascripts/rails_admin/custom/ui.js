$(document).on('rails_admin.dom_ready', function(){
  ...
  // 2016-10-24
  // this file moves the buttons to the left side and allows horizontal scrolling in rails admin..
  // https://github.com/sferik/rails_admin/wiki/Horizontally-scrolling-table-with-frozen-columns-in-list-view
  // to update assets, edit..
  //    config\initializers\assets.rb and bump the version.. 
